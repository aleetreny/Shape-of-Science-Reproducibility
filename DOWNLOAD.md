...
Consultar `CORPUS_PROTOCOL.md` para las reglas del corpus. Antes de tocar código, consultar `./download.sh status`. No cambiar el programa mientras la descarga está abierta. Se guardan huellas de los módulos al comenzar para impedir una reanudación silenciosa con otras reglas.
